(function () {
  ...
  class GameModel {
    ...
    restart() {
      ...
      this._state = Object.assign({}, this._state, {questions: this.gameData, username: this.playerName, numberOfQuestions: this.gameData.length});
    }
  ...
  class Application {
    ...
    static showStat(state, playerName) {
      Loader.saveResults(state, playerName)
        ...
        .then((statScreen) => showScreen$1(statScreen.element));
    }
